...
## 200 - AWS OpenShift GitOps Bootstrap

Provisions OpenShift GitOps into an existing AWS cluster and bootstraps it to a gitops repository
...
![Reference Diagram](./200-aws-openshift-gitops.png)
...
- [docs/ocp-login.md](docs/ocp-login.md)
